...
class PoseNet:
    ...
    def inference_paf_pcm(self, image_input):
        ...
        (self.concat(['mconv7_stage3_l1', 'mconv7_stage3_l2', 'conv_4_4_cpm'], 'concat_stage4')
             .conv(128, 7, 'mconv1_stage4_l1')
             .conv(128, 7, 'mconv2_stage4_l1')
             .conv(128, 7, 'mconv3_stage4_l1')
             .conv(128, 7, 'mconv4_stage4_l1')
             .conv(128, 7, 'mconv5_stage4_l1')
             .conv(128, 1, 'mconv6_stage4_l1')
             .conv(5 * 2, 1, 'mconv7_stage4_l1', relu=False))
        (self.feed('concat_stage4')
             ...
             .conv(128, 7, 'mconv5_stage4_l2')
             .conv(128, 1, 'mconv6_stage4_l2')
             .conv(6, 1, 'mconv7_stage4_l2', relu=False)
         )

        (self.concat(['mconv7_stage4_l1', 'mconv7_stage4_l2', 'conv_4_4_cpm'], 'concat_stage5')
             .conv(128, 7, 'mconv1_stage5_l1')
             .conv(128, 7, 'mconv2_stage5_l1')
             .conv(128, 7, 'mconv3_stage5_l1')
             .conv(128, 7, 'mconv4_stage5_l1')
             .conv(128, 7, 'mconv5_stage5_l1')
             .conv(128, 1, 'mconv6_stage5_l1')
             .conv(5 * 2, 1, 'mconv7_stage5_l1', relu=False))
        (self.feed('concat_stage5')
             ...
             .conv(128, 7, 'mconv5_stage5_l2')
             .conv(128, 1, 'mconv6_stage5_l2')
             .conv(6, 1, 'mconv7_stage5_l2', relu=False)
         )

        (self.concat(['mconv7_stage5_l1', 'mconv7_stage5_l2', 'conv_4_4_cpm'], 'concat_stage6')
         .conv(128, 7, 'mconv1_stage6_l1')
         .conv(128, 7, 'mconv2_stage6_l1')
         .conv(128, 7, 'mconv3_stage6_l1')
         .conv(128, 7, 'mconv4_stage6_l1')
         .conv(128, 7, 'mconv5_stage6_l1')
         .conv(128, 1, 'mconv6_stage6_l1')
         .conv(5 * 2, 1, 'mconv7_stage6_l1', relu=False))
        (self.feed('concat_stage6')
         .conv(128, 7, 'mconv1_stage6_l2')
         .conv(128, 7, 'mconv2_stage6_l2')
         .conv(128, 7, 'mconv3_stage6_l2')
         .conv(128, 7, 'mconv4_stage6_l2')
         .conv(128, 7, 'mconv5_stage6_l2')
